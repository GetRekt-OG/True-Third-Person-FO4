...
namespace TrueThirdPerson {
    ...
    inline void LoadConfig() {
        ...
        g_config.hideSwimmingWeapon =
            GetPrivateProfileIntW(L"Main", L"HideWeaponWhileSwimming", 1, g_ini.c_str()) != 0;
        g_config.targetLock =
        ...
        g_config.switchPixels = static_cast<float>(std::clamp(
            ...
            1000U));
        g_config.smoothHipFire =
            GetPrivateProfileIntW(L"Main", L"SmoothHipFire", 1, g_ini.c_str()) != 0;
        g_config.keepHolsterView =
            GetPrivateProfileIntW(L"Main", L"KeepHolsterView", 1, g_ini.c_str()) != 0;
        g_config.hipFireFacing =
            GetPrivateProfileIntW(L"Main", L"HipFireFacing", 1, g_ini.c_str()) != 0;
